...
function injectHalloweenTheme() {
    ...
    if ((today.getMonth() == 9 && today.getDate() > 24) || (today.getMonth() == 10 && today.getDate() < 7) || window.location.hash == "#HalloweenTheme") { // not only 10/31
        console.log("🎃");
        // CSS for theme.
        ...
        function summonBats() { // Summon bats on click.
        ...
        pumpkinElem.addEventListener("click", function() { // Clicking pumpkin will change cursor image to bat and summon bats.
            document.body.classList.add("JsHalloweenCursor");
            batCursorEnabled = true;
            summonBats();
        });
        document.body.addEventListener("click", function() { // After the cursor is changed to bat, clicking anywhere on the body will summon bats.
            if (batCursorEnabled) {
                summonBats();
            }
        });
        // Override the background image to halloween themed image generated by Gemini.
        ...
        // Shuffle through texts above the pumpkin.
        const halloweenTextList = ["Happy Halloween!", "Trick or Treat!", "Boo!", "Click the pumpkin!", "Beware of bats!"];
        ...
        console.log("Halloween theme injected. Happy Halloween.");
    }
}
